...
MODEL = ""                      # pretrained model path (.pt file)
...
OPTIMIZER = "SGD"               # SGD, Adam, AdamW, NAdam, RAdam, auto
LR0 = 0.01                      # initial learning rate
LRF = 0.01                      # final LR as fraction of LR0
MOMENTUM = 0.937                # SGD momentum / Adam beta1
WEIGHT_DECAY = 0.001            # L2 regularization
WARMUP_EPOCHS = 6.0             # LR warmup epochs
...
FLIPLR = 0.3                    # horizontal flip prob  ← tuned (default 0.5 was worse)
FLIPUD = 0.0                    # vertical flip prob
MOSAIC = 1.0                    # mosaic (0-1)
MIXUP = 0.0                     # mixup (0-1)
COPY_PASTE = 0.0                # copy-paste (0-1)
ERASING = 0.0                   # random erasing (0-1)  ← tuned (default 0.4 was worse)
